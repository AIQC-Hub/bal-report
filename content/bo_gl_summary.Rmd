...
description: |
  Profile summary report generated from a single Parquet file has been created from eight NetCDF files from the Baltic Sea in situ NRT observations.
output: 
...
r_func_path <- "./_func"
r_funcs <- c("libraries.Rmd", "common.Rmd", "common_bo_gl.Rmd", "summary_common.Rmd")
```
...
src <- knitr::knit_expand(t_s_location_filtering, df=df_name)
